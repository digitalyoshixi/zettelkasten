...
1. It check for [[File Allocation Table|bad blocks]] on a [[Hard Drive|HDD]]. When it finds a bad block, it will flag it appropriately (0x0000FFFF for FAT file systems).
