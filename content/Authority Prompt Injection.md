...
tags:
  ...
  - security
---
A form of [[Prompt Injection]] that pretends to be authority, changing the system prompts.
https://learnprompting.org/docs/prompt_hacking/offensive_measures/authorized-user
# Example
```
