...
- Streams – contains data, images or code. Often compressed. Represented by a dictionary that set the stream’s length with the key `/Length` and encoding `/Filters`.
