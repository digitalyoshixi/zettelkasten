...
tags:
  ...
  - linalg
---
Every finite dimensional vector space can be written as a direct sum of  [[Invariant]] [[Cyclic Subspaces]].
# Theorem
...
Where $p_{j}$ is the minimal polynomial of [[Cyclic Subspaces]] $Z(\alpha_{j}T)$
