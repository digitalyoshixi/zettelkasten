...
Make sure you write a comma, or "such that", after writing a [[Mathematical Statement]] including $\exists$.
Example:
$\exists x \in R$ such that $x^3 < 0$.
In A31, you will use a comma.
In A67, you will use "such that".
# Proof Writing
