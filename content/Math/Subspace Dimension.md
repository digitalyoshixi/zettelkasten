...
tags:
  ...
  - linalg
---
The dimension of a given subspace $U$, $dim(U)$ is the size of its [[Basis]]. This will always remain consistent by [[All Bases are Same Size Theorem|Invariance Theorem]].
# Dimension and Spanability
If you have a subspace $S$ of $m$ vectors and $k = dim(U)$
