...
6. Invoke 1,2 with $\epsilon_{1} = \frac{1}{1+|b|}\frac{\epsilon}{2}, \epsilon_{2} = \frac{1}{|a|+1}, e_{3} = 1$
7. Note that $\exists N_{1} > 0$ s.t $\forall n \in \mathbb{N}, n > N_{1}$ then, $|a_{n} - a| <\epsilon_{1}$ as $\{ a_{n} \}$ converges
8. Note that $\exists N_{2} > 0$ s.t $\forall n \in \mathbb{N}, n > N_{2}$ then, $|b_{n} - b| <\epsilon_{2}$ as $\{ b_{n} \}$ converges
...
19. $< (1 + |b|)\frac{1}{1+|b|}\frac{\epsilon}{2} + |a|\frac{1}{|a|+1} \frac{\epsilon}{2}$