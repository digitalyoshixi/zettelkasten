...
1. If $m$ is odd, convert as many $sin^2x \to(1-\cos^2x)$
   You'll be left with $\sin x\ dx$.
   Sub $u=cosx$ and $du=-sinx\ dx$
2. if $n$ is odd, convert as many $cos^2x \to (1-\sin^2x)$
   You'll be left with $\cos xdx$
   Sub $u=\sin x$ and $du=\cos x\ dx$
3. If both $n$ and $m$ are even, use [[Half Angle Identity]] and rearrange.
