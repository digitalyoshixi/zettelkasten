...
1. Nodes no longer have weights and biases
   ![[Long Short Term Memory-20250228035127976.webp]]
	1. A state that represents the long-term memory connects all nodes
	2. A state that represents short-term memory connects all nodes with a weight connecting to each mode
2. ![[Long Short Term Memory-20250228035346266.webp]]
