...
3. Everytime you connect your [[Metamask 1]] wallet to the browser, an `ethereum` variable is injected into your browser window. This allows us to tell if a browser is web3 compatible
