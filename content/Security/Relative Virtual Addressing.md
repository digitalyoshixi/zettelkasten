...
aliases:
  - RVA
---
Relative virtual addresses map physical memory and software by creating a page table used between the two. Splits the memory into pages for each designated program. The advantages include:
