...
Gather publicly available data ([[IP Address]], [[Domain Name]], employee names, organizational structure).
Use [[OSINT Fundamentals]]
...
# Delivery
Payload written to a deliverable (executable, [[USB Flash Drive]], [[Electronic Mail|Email]])
# Exploitation
Exploit a vulnerability to deploy the payload.
# Installation
Install [[Malware]]
# [[Command and Control Server|Command and Control]]
