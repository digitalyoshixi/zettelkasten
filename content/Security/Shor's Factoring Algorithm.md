...
5. Uses [[Quantum Phase]] to use modular exponentiation and the inverse of [[Quantum Fourier Transform|QFT's]] $\frac{1}{p}$ to estimate the phase $p$ of the quantum state
# Intuition
