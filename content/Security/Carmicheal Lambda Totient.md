...
c = 128391911110189182102909037 * 2**8
y = pow(a, b, c)
...
print(x)
```
that final `lam=carmicheal_lambda(...)` area, is where you put the your factors of `c`
so, if my factors of c were c = 5^2 * 3^1 * 2^2, then that place would look like: `lam = carmicheal_lambda([(5,2),(3,1),(2,2)])`
