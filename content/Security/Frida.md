...
tags:
  - reverse_engineering
---
A [[Flutter]] reverse engineering tool that can be used to hook and intercept function calls.
...
4. Download the correct server release off https://github.com/frida/frida/releases
   ![[Frida-20240901024741197.webp]]
5. Unzip the xz file 
   ![[Frida-20240901024937522.webp]]
6. `adb push <fridaserverfile> /data/local/tmp`
   ![[Frida-20240901025147843.webp]]
7. `adb shell`
8. `su`
9. `cd /data/local/tmp`
10. `chmod 755 <fridaserverfile>`
11. `./<fridaserver> &`
# Starting Frida 
