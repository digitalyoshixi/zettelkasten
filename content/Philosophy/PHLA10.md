...
---
# Notes
- phla10.utsc@course.utoronto.ca
- Best 2/3 argument maps are graded
...
- Remember arguments
	- Especially those covered in lecture
...
- Questions are:
	...
	- Short answer
### Example Questions
- Define substrate independence
- Assess the following arguments for validity and soundness
- Translate an argument into premise-conclusion form
- Mini essay to give a brief argument as to why we should reject a premise, then choose another premise and explain wy we should reject that premise. Explain which two arguments you think is better. 3-4 paragraphs.
# Concepts
- [[Epistemology]]
- [[Metaphysics]]
- [[Knowledge]]
