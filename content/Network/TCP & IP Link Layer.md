...
The 5 layer [[TCP & IP]] model simply splits the link layer into its 2 functions of data transfer and physical media within the [[TCP & IP Data Layer]] and [[TCP & IP Physical Layer]].
