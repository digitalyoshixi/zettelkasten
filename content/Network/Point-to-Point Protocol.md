...
aliases:
  - PPP
---
One of the protocols used to for data transfer on serial lines. 
Similar to [[High-Level Data Link Control Protocol|HDLC]] but designed for [[TCP & IP Model|TCP/IP]].
Largely replaced by [[IPsec]]
# Revisions
